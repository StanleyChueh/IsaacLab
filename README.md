...
### Generate augemented dataset w domain randomization(background changing and camera shaking)

with --enable_camera_shake
...
./isaaclab.sh -p scripts/imitation_learning/isaaclab_mimic/generate_dataset.py \
    ...
    --generation_num_trials 50 --num_envs 4 --enable_cameras \
    --enable_domain_randomization --task_mode handover --domain_randomization_profile full \
    --randomize_object_size --enable_camera_shake
```
